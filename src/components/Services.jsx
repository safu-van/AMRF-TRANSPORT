    ...
    <div className="w-full px-5 md:px-10 mb-10 text-white font-ubuntu">
      <div className="w-full bg-[#005BAA] rounded-lg">
        <div className="h-1/3 flex justify-center items-center py-14">
          <span className="text-2xl md:text-4xl font-bold">Our Services</span>
        </div>
        <div className="flex flex-wrap justify-center gap-8 px-5 pb-10">
          <div className="w-full sm:w-[18rem] lg:w-64 p-6 md:p-8 rounded-lg shadow-custom space-y-3 bg-white text-black transition-transform transform hover:scale-105 hover:shadow-lg hover:bg-[#f0f9ff]">
            <img src="/truck.png" className="h-12 mx-auto mb-4" alt="Land Freight" />
          ...
          <div className="w-full sm:w-[18rem] lg:w-64 p-6 md:p-8 rounded-lg shadow-custom space-y-3 bg-white text-black transition-transform transform hover:scale-105 hover:shadow-lg hover:bg-[#f0f9ff]">
            <img src="/ship.png" className="h-12 mx-auto mb-4" alt="Sea Freight" />
          ...
          <div className="w-full sm:w-[18rem] lg:w-64 p-6 md:p-8 rounded-lg shadow-custom space-y-3 bg-white text-black transition-transform transform hover:scale-105 hover:shadow-lg hover:bg-[#f0f9ff]">
            <img src="/flight.png" className="h-12 mx-auto mb-4" alt="Air Freight" />
